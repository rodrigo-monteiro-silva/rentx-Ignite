...
const ListRentalByUserUseCase_1 = require("./ListRentalByUserUseCase");
class ListRentalByUserController {
    handle(request, response) {
        return __awaiter(this, void 0, void 0, function* () {
            const { id } = request.user;
            const listRentalsByUserUseCase = tsyringe_1.container.resolve(ListRentalByUserUseCase_1.ListRentalsByUserUseCase);
